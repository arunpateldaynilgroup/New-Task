...
public class RoleController {
	...
	@PostMapping
	public ResponseEntity<Object> save(@RequestBody Roles role)  throws Exception  {
		return new ResponseEntity<>(service.save(role), HttpStatus.CREATED);
	}
	
	@PutMapping("/{id}")
	public ResponseEntity<Object> update(@PathVariable Long id, @RequestBody Roles role)  throws Exception  {
