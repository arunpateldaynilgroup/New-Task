...
public class ProjectsController {
	...
	@PostMapping
	public ResponseEntity<Object> save(@RequestBody Projects request)  throws Exception  {
		return new ResponseEntity<>(service.save(request), HttpStatus.CREATED);
	}
	
	@PutMapping("/{id}")
	public ResponseEntity<Object> update(@PathVariable Long id, @RequestBody Projects request)  throws Exception  {
